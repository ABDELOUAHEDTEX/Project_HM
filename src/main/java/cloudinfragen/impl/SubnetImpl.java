 ...
 *   <li>{@link cloudinfragen.impl.SubnetImpl#getTypeSubnet <em>Type Subnet</em>}</li>
...
public class SubnetImpl extends MinimalEObjectImpl.Container implements Subnet {
	...
	/**
	 * The default value of the '{@link #getTypeSubnet() <em>Type Subnet</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getTypeSubnet()
	 * @generated
	 * @ordered
	 */
	protected static final String TYPE_SUBNET_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getTypeSubnet() <em>Type Subnet</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getTypeSubnet()
	 * @generated
	 * @ordered
	 */
	protected String typeSubnet = TYPE_SUBNET_EDEFAULT;
	 ...
	 */
	@Override
	public void setTypeSubnet(String newTypeSubnet) {
		String oldTypeSubnet = typeSubnet;
		typeSubnet = newTypeSubnet;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CloudinfragenPackage.SUBNET__TYPE_SUBNET, oldTypeSubnet, typeSubnet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case CloudinfragenPackage.SUBNET__CIDR:
				return getCidr();
			case CloudinfragenPackage.SUBNET__TYPE_SUBNET:
				return getTypeSubnet();
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case CloudinfragenPackage.SUBNET__CIDR:
				...
				return;
			case CloudinfragenPackage.SUBNET__TYPE_SUBNET:
				setTypeSubnet(TYPE_SUBNET_EDEFAULT);
				return;
			case CloudinfragenPackage.SUBNET__AVAILABILITY_ZONE:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case CloudinfragenPackage.SUBNET__TYPE_SUBNET:
				return TYPE_SUBNET_EDEFAULT == null ? typeSubnet != null : !TYPE_SUBNET_EDEFAULT.equals(typeSubnet);
			case CloudinfragenPackage.SUBNET__AVAILABILITY_ZONE:
