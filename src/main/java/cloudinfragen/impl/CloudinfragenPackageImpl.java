...
public class CloudinfragenPackageImpl extends EPackageImpl implements CloudinfragenPackage {
	 ...
	 */
	@Override
	public EAttribute getInfrastructure_Provider() {
	 ...
	 */
	@Override
	public EReference getComputeInstance_Subnet() {
	 ...
	 */
	@Override
	public EReference getAutoScalingGroup_Template() {
	...
	public EReference getAutoScalingGroup_Instances() {
		return (EReference)autoScalingGroupEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EAttribute getSubnet_TypeSubnet() {
	...
	public void createPackageContents() {
		...
		createEAttribute(infrastructureEClass, INFRASTRUCTURE__PROVIDER);
		...
		createEReference(computeInstanceEClass, COMPUTE_INSTANCE__SUBNET);
		...
		createEReference(autoScalingGroupEClass, AUTO_SCALING_GROUP__TEMPLATE);
		...
		createEAttribute(subnetEClass, SUBNET__TYPE_SUBNET);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getInfrastructure_Provider(), ecorePackage.getEString(), "provider", null, 1, 1, Infrastructure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getComputeInstance_Subnet(), this.getSubnet(), null, "subnet", null, 0, 1, ComputeInstance.class, !IS_TRANSIENT, !IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getComputeInstance_SecurityGroups(), this.getSecurityGroup(), null, "securityGroups", null, 1, -1, ComputeInstance.class, !IS_TRANSIENT, !IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getAutoScalingGroup_Template(), this.getComputeInstance(), null, "template", null, 1, 1, AutoScalingGroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getSubnet_TypeSubnet(), ecorePackage.getEString(), "typeSubnet", null, 1, 1, Subnet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
