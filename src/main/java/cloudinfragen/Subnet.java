 ...
 *   <li>{@link cloudinfragen.Subnet#getTypeSubnet <em>Type Subnet</em>}</li>
...
public interface Subnet extends CloudResource {
	...
	/**
	 * Returns the value of the '<em><b>Type Subnet</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Type Subnet</em>' attribute.
	 * @see #setTypeSubnet(String)
	 * @see cloudinfragen.CloudinfragenPackage#getSubnet_TypeSubnet()
	 * @model unique="false" required="true" ordered="false"
	 * @generated
	 */
	String getTypeSubnet();

	/**
	 * Sets the value of the '{@link cloudinfragen.Subnet#getTypeSubnet <em>Type Subnet</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Type Subnet</em>' attribute.
	 * @see #getTypeSubnet()
	 * @generated
	 */
	void setTypeSubnet(String value);
