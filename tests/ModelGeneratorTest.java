...
public class ModelGeneratorTest {
    ...
    public void testValidateModel() {
        ...
        // Model should be valid if ComputeInstance has security groups
        // Note: This test may need adjustment based on actual validation logic
        boolean isValid = modelGen.validateModel(infra);
        // Validation may fail if relationships aren't properly established
        assertNotNull(infra);
    }
    ...
    public void testTerraformGeneration() {
        ...
        assertTrue(terraform.contains("aws"));
    }
